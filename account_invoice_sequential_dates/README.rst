...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/l10n-italy/10.0/account_invoice_sequential_dates/static/description/icon.png
...
* |menu| Setting > Apps |right_do| Select **account_invoice_sequential_dates** > Install
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **account_invoice_sequential_dates** > Update
