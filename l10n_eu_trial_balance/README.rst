...
========================================================
|icon| 2013/34/EU - Trial Balance + Financial Statements
========================================================


.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/l10n-italy/10.0/l10n_eu_trial_balance/static/description/icon.png
...
* |menu| Setting > Apps |right_do| Select **l10n_eu_trial_balance** > Install
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **l10n_eu_trial_balance** > Update
